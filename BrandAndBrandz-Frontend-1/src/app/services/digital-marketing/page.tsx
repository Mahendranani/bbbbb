...
export default function DigitalMarketingPage() {
    ...
    const whatWeDo = [
        "Define growth objectives and measurable KPIs",
        "Design content and social media systems",
        "Plan distribution, funnels, and audience journeys",
        "Execute performance-driven campaigns",
        "Monitor, optimize, and refine continuously",
    ];
        ...
        <div className="min-h-screen relative overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    <br />
                    We design growth systems aligned with brand strategy.
                </motion.p>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    Marketing is applied only after structure and clarity are established.
                </motion.p>
                ...
                <motion.div variants={itemVariants}>
                    ...
                    <motion.p
                        ...
                        variants={itemVariants}
                    >
                        Consistent visibility, meaningful engagement, and sustainable growth—not noise.
                    </motion.p>
                </motion.div>
            </motion.div>
        </div>
