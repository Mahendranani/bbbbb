...
export default function BrandFoundationPage() {
    ...
    const whatWeDo = [
        "Analyze the business idea, problem space, and feasibility",
        "Define target audience, market fit, and differentiation",
        "Develop brand positioning, messaging, and tone of voice",
        "Create naming concepts aligned with long-term vision",
        "Design logo and complete visual identity system",
        "Document brand guidelines for consistent execution",
    ];

    return (
        <div className="min-h-screen relative overflow-hidden">
            {/* Background with blue gradient glow */}
            <div
            ...
            >
                ...
                {/* Main Title - Shared Element */}
                <motion.h1
                    layoutId="service-title-0"
                ...
                >
                    From Business Idea to Brand Foundation
                </motion.h1>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    We work with early-stage founders and teams to convert ideas into well-defined, credible brands with clear direction.
                </motion.p>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    This phase eliminates ambiguity and sets a strong base for every future decision.
                </motion.p>
                ...
                <motion.div variants={itemVariants}>
                    ...
                    <motion.p
                        ...
                        variants={itemVariants}
                    >
                        A structured brand foundation that aligns stakeholders, reduces confusion, and prepares the business for scale.
                    </motion.p>
                </motion.div>
            </motion.div>
        </div>
