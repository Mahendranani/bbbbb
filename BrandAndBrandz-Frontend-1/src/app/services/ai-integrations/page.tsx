...
export default function AIIntegrationsPage() {
    ...
    const whatWeDo = [
        "AI chatbots for websites and platforms",
        "Intelligent customer support and engagement tools",
        "AI agents for internal workflows and operations",
        "Custom AI integrations across existing systems",
    ];
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            >
                ...
                >
                    AI Assistants, Agents & Intelligent Integrations
                </motion.h1>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    We integrate AI responsibly to enhance efficiency and insight never to replace human judgment.
                </motion.p>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    AI is treated as a support layer within a larger system.
                </motion.p>
                ...
                <motion.div variants={itemVariants}>
                    ...
                    <motion.p
                        ...
                        variants={itemVariants}
                    >
                        Smarter operations, faster responses, and scalable intelligence without compromising trust.
                    </motion.p>
                </motion.div>
            </motion.div>
        </div>
