...
export default function StrategyResearchPage() {
    ...
    const whatWeDo = [
        "Market, competitor, and industry analysis",
        "Audience behavior and insight research",
        "Data analysis and performance tracking",
        "Strategic roadmaps and planning frameworks",
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            >
                ...
                >
                    Strategy, Research & Data-Driven Reporting
                </motion.h1>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    We believe strong decisions are built on understanding not assumptions.
                </motion.p>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    This service supports leadership with clarity and insight.
                </motion.p>
                ...
                <motion.div variants={itemVariants}>
                    ...
                    <motion.p
                        ...
                        variants={itemVariants}
                    >
                        Confident decision-making backed by research, data and structured thinking.
                    </motion.p>
                </motion.div>
            </motion.div>
        </div>
